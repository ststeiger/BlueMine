...
import { defaults as defaultOptions, } from "./types/options";
import English from "./l10n/default";
import { arrayify, debounce, int, pad } from "./utils/index";
...
function FlatpickrInstance(element, instanceConfig) {
    ...
    function onMouseOver(elem) {
        if (self.selectedDates.length !== 1 ||
            ...
            return;
        var hoverDate = elem.dateObj.getTime(), initialDate = self.parseDate(self.selectedDates[0], undefined, true).getTime(), rangeStartDate = Math.min(hoverDate, self.selectedDates[0].getTime()), rangeEndDate = Math.max(hoverDate, self.selectedDates[0].getTime());
        var months = self.daysContainer
            .children, firstDay = months[0].children[0].dateObj.getTime(), lastDay = months[months.length - 1]
