...
namespace BlueMine.TagHelpers
{
        ...
        : Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper
    {
        ...
        private IFileVersionProvider m_fileVersionProvider;
            ...
            : IFileVersionProvider
        {
            ...
            Microsoft.Extensions.FileProviders.IFileProvider m_provider;
            Microsoft.Extensions.Caching.Memory.IMemoryCache m_cache;
            PathString m_pathBase;

            public FileVersionProvider(Microsoft.Extensions.FileProviders.IFileProvider provider,
                Microsoft.Extensions.Caching.Memory.IMemoryCache cache,
                PathString pathBase)
            {
                this.m_provider = provider;
                this.m_cache = cache;
                this.m_pathBase = pathBase;
            }


            string IFileVersionProvider.AddFileVersionToPath(PathString requestPathBase, string path)
            {
                return path;
            }
        }
        ...
        private void EnsureFileVersionProvider()
        {
            ...
            {
                this.m_fileVersionProvider = new FileVersionProvider(
